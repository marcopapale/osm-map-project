...
function addMarker(lat, lng, name, category) {
  ...
  marker.bindPopup(
    `<div style='position: relative;'>
      <button style='position: absolute; top: -10px; right: -10px; width: 20px; height: 20px; background: red; color: white; border: none; border-radius: 50%; cursor: pointer;' onclick='this.closest(".leaflet-popup-content-wrapper").parentNode._popup._map.closePopup()'>×</button>
